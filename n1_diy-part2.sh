...
# btrfs-progs
sed -i 's/PKG_VERSION:=.*/PKG_VERSION:=5.19/g' feeds/packages/utils/btrfs-progs/Makefile
sed -i 's/PKG_HASH:=.*/PKG_HASH:=1fbcf06e4b2f80e7a127fd687ed4625a5b74fa674fe212c836ff70e0edfcccf9/g' feeds/packages/utils/btrfs-progs/Makefile
...
# python-certifi
sed -i 's/PKG_VERSION:=.*/PKG_VERSION:=2022.6.15/g' feeds/packages/lang/python/python-certifi/Makefile
sed -i 's/PKG_HASH:=.*/PKG_HASH:=84c85a9078b11105f04f3036a9482ae10e4621616db313fe045dd24743a0820d/g' feeds/packages/lang/python/python-certifi/Makefile
...
sed -i 's/PKG_HASH:=.*/PKG_HASH:=d16c4be2a0476be039dce114401e7e8417f704eb89d9e5add7b3538dd58a2462/g' feeds/packages/utils/hwdata/Makefile
...
# gnutls
sed -i 's/PKG_VERSION:=.*/PKG_VERSION:=3.7.7/g' feeds/packages/libs/gnutls/Makefile
sed -i 's/PKG_HASH:=.*/PKG_HASH:=be9143d0d58eab64dba9b77114aaafac529b6c0d7e81de6bdf1c9b59027d2106/g' feeds/packages/libs/gnutls/Makefile
