...
# btrfs-progs
sed -i 's/PKG_VERSION:=.*/PKG_VERSION:=6.0/g' feeds/packages/utils/btrfs-progs/Makefile
sed -i 's/PKG_HASH:=.*/PKG_HASH:=469e1b2ec842a6e64848ae63de3022446f8009e975f7beb919191f137cbdd534/g' feeds/packages/utils/btrfs-progs/Makefile
...
# curl
#sed -i 's/PKG_VERSION:=.*/PKG_VERSION:=7.85.0/g' feeds/packages/net/curl/Makefile
#sed -i 's/PKG_HASH:=.*/PKG_HASH:=88b54a6d4b9a48cb4d873c7056dcba997ddd5b7be5a2d537a4acb55c20b04be6/g' feeds/packages/net/curl/Makefile
...
# expat
sed -i 's/PKG_VERSION:=.*/PKG_VERSION:=2.4.9/g' feeds/packages/libs/expat/Makefile
sed -i 's/PKG_HASH:=.*/PKG_HASH:=6e8c0728fe5c7cd3f93a6acce43046c5e4736c7b4b68e032e9350daa0efc0354/g' feeds/packages/libs/expat/Makefile
...
sed -i 's/PKG_VERSION:=.*/PKG_VERSION:=1.4.1/g' feeds/packages/lang/python/python-websocket-client/Makefile
sed -i 's/PKG_HASH:=.*/PKG_HASH:=f9611eb65c8241a67fb373bef040b3cf8ad377a9f6546a12b620b6511e8ea9ef/g' feeds/packages/lang/python/python-websocket-client/Makefile
...
# python-sqlalchemy
sed -i 's/PKG_VERSION:=.*/PKG_VERSION:=1.4.41/g' feeds/packages/lang/python/python-sqlalchemy/Makefile
sed -i 's/PKG_HASH:=.*/PKG_HASH:=0292f70d1797e3c54e862e6f30ae474014648bc9c723e14a2fda730adb0a9791/g' feeds/packages/lang/python/python-sqlalchemy/Makefile
...
# hwdata
sed -i 's/PKG_VERSION:=.*/PKG_VERSION:=0.362/g' feeds/packages/utils/hwdata/Makefile
...
# smartdns
sed -i 's/PKG_VERSION:=.*/PKG_VERSION:=1.2022.38.1/g' feeds/packages/net/smartdns/Makefile
sed -i 's/PKG_SOURCE_VERSION:=.*/PKG_SOURCE_VERSION:=9bc857f628299573c7eca0833229d9812b1c1de4/g' feeds/packages/net/smartdns/Makefile
sed -i 's/PKG_MIRROR_HASH:=.*/PKG_MIRROR_HASH:=a202b765e6ce8355335c80214819add3ed72a82426b033d7d5adf1448b415063/g' feeds/packages/net/smartdns/Makefile
...
# libnetwork
sed -i 's/PKG_SOURCE_VERSION:=.*/PKG_SOURCE_VERSION:=0dde5c895075df6e3630e76f750a447cf63f4789/g' feeds/packages/utils/libnetwork/Makefile
sed -i 's/PKG_SOURCE_DATE:=.*/PKG_SOURCE_DATE:=2022-07-16/g' feeds/packages/utils/libnetwork/Makefile
sed -i 's/PKG_MIRROR_HASH:=.*/PKG_MIRROR_HASH:=ff5c7f30777c5fec50a59b79ff0e056fd09e3e55f3475816a21376bf72812d42/g' feeds/packages/utils/libnetwork/Makefile
...
# nghttp2
sed -i 's/PKG_VERSION:=.*/PKG_VERSION:=1.50.0/g' feeds/packages/libs/nghttp2/Makefile
sed -i 's/PKG_HASH:=.*/PKG_HASH:=af24007e34c18c782393a1dc3685f8fd5b50283e90a9191d25488eb50aa2c825/g' feeds/packages/libs/nghttp2/Makefile
...
# bind
#sed -i 's/PKG_VERSION:=.*/PKG_VERSION:=9.18.7/g' feeds/packages/net/bind/Makefile
#sed -i 's/PKG_HASH:=.*/PKG_HASH:=9e2acf1698f49d70ad12ffbad39ec6716a7da524e9ebd98429c7c70ba1262981/g' feeds/packages/net/bind/Makefile
