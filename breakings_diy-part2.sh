...
# curl
sed -i 's/PKG_VERSION:=.*/PKG_VERSION:=8.1.0/g' feeds/packages/net/curl/Makefile
sed -i 's/PKG_HASH:=.*/PKG_HASH:=6bd80ad4f07187015911216ee7185b90d285ac5162aed1bded144f9f93232a3c/g' feeds/packages/net/curl/Makefile
