...
rm -rf feeds/packages/net/samba4 feeds/packages/lang/perl
git_sparse_clone master "https://github.com/openwrt/packages" "temp" net/samba4 lang/perl && mv -n samba4 perl package/
